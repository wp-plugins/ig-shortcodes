...
Icons by FontAwesome (http://fortawesome.github.io/Font-Awesome/) licensed under GPL license.
Social icons font are generated by http://fontello.com open source project and are licensed under Open Source License.
...
= Premium Add-ons =
* IG Shortcodes (http://themes.iografica.it/downloads/ig-shortcodes-premium) add additional shortcodes and give access to priority support.
Premium shortcodes:
- Box features
- Icon list
